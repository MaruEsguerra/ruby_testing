...
describe BinaryGame do
  ...
  describe '#player_input' do
    ...
    context 'when user inputs an incorrect value once, then a valid input' do
      before do
        letter_input = 'u'
        valid_input = '8'
        allow(game_input).to receive(:gets).and_return(letter_input, valid_input)
      end
    ...
    context 'when user inputs two incorrect values, then a valid input' do
      before do
        ...
        symbol_input = '&'
        valid_input = '3'
        allow(game_input).to receive(:gets).and_return(letter_input, symbol_input, valid_input)
      end
  ...
  describe '#verify_input' do
    ...
    context 'when given a valid input as argument' do
      it 'returns valid input' do
        ...
        user_input = 50
        verified_input = verify_game.verify_input(min, max, user_input)
        expect(verified_input).to eq(50)
      end
    end
  ...
  describe '#display_turn_order' do
    ...
    subject(:game_display_turn) { described_class.new(1, 100) }
