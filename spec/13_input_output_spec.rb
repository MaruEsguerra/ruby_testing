...
describe NumberGame do
  ...
  describe '#game_over?' do
    ...
    subject(:game_continue) { described_class.new(8, '7')}
  ...
  describe '#final_message' do
    ...
    context 'when count is 2-3' do
      # remove the 'x' before running this test
      subject(:game_three) { described_class.new(2, '2', 3) }
      it 'outputs correct phrase' do
    ...
    context 'when count is 4 and over' do
      # remove the 'x' before running this test
      subject(:game_nine) { described_class.new(4, '4', 9) }
      it 'outputs correct phrase' do
        hard_phrase = "That was hard. It took you 9 guesses!\n"
        expect { game_nine.final_message }.to output(hard_phrase).to_stdout
      end
    end
  end
end
