...
describe FindNumber do
  ...
  describe '#game_over?' do
    context 'when guess and random_number are equal' do
      ...
      let(:answer_number) { double('random_number', value: 8) }
      subject(:game_end) { described_class.new(7, 8, answer_number, 8) }
    ...
    context 'when guess and random_number are not equal' do
      let(:answer_number) { double('random_number', value: 8) }
      subject(:game_continues) { described_class.new(0, 3, answer_number, 3) }
